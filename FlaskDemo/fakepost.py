...
with app.app_context():
    ...
    fakepost = [
        ...
        Activity (title="Join Badminton with me", category="badminton", date="14-9-2025", location="Dewan MMU", gender="Female"),
        Activity (title="Swimming day yayy", category="swim", date="19-10-2025", location="Swimming Pool MMU", gender="Male")
    ]        
